...
// Logout Loading Screen - Similar to login but with different colors and messages
const CuteLogoutProgress = () => {
  const [progress, setProgress] = useState(0);
